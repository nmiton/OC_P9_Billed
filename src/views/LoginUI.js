            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input type="email" data-testid="employee-email-input" name="inputEmailEmployee" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPasswordEmployee">Mot de passe</label>
                  <input type="password" name="inputPasswordEmployee" data-testid="employee-password-input" class="form-control" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <input type="email" name="inputEmailAdmin" data-testid="admin-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPasswordAdmin">Mot de passe</label>
                  <input type="password" name="inputPasswordAdmin" data-testid="admin-password-input" class="form-control" placeholder="******" required>
